...
BLOG_AUTHOR = "Minister of Foreign Affairs"  # (translatable)
BLOG_TITLE = "State News"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://truslav.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "https://truslav.com/state-news/"
BLOG_EMAIL = "buroofforeignaffairs@truslav.com"
BLOG_DESCRIPTION = "Archive of the State News of Our Glorious Union, the Home of Tru Communism, Truslavistan (A Soviet Republic)."  # (translatable)
...
DEPLOY_COMMANDS = {'default': [ 'cp -r ../../truslav.com/public/output -y',
'cd ../../truslav.com && firebase deploy'
]}
...
<div class="icons">
                        <a href="https://twitter.com/truslavistan" target="_blank" class="icon"><img src="/images/twitter.svg"></a>
                        <a href="mailto:buroofforeignaffairs@truslav.com" target="_blank" class="icon"><img src="/images/email.svg"></a>
                        <a href="https://facebook.com" target="_blank" class="icon"><img src="/images/facebook.svg"></a>
                        <a href="https://patreon.com/truslavistan" target="_blank" class="icon"><img class="icon" src="/images/Patreon.png"></a>
                    </div>
